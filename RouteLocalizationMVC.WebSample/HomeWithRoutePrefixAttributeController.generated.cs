...
{
    public partial class HomeWithRoutePrefixAttributeController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeWithRoutePrefixAttributeController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected HomeWithRoutePrefixAttributeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeWithRoutePrefixAttributeController Actions { get { return MVC.HomeWithRoutePrefixAttribute; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "HomeWithRoutePrefixAttribute";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "HomeWithRoutePrefixAttribute";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Book = "~/Views/HomeWithRoutePrefixAttribute/Book.cshtml";
            public readonly string Index = "~/Views/HomeWithRoutePrefixAttribute/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeWithRoutePrefixAttributeController : RouteLocalizationMVC.WebSample.Controllers.HomeWithRoutePrefixAttributeController
    {
        public T4MVC_HomeWithRoutePrefixAttributeController() : base(Dummy.Instance) { }
